...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Hack47@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Hack47 API";

        private String description = "Hack47 API documentation";
