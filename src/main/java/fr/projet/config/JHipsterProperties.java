...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "JHipsterAppli@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "JHipsterAppli API";

        private String description = "JHipsterAppli API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "JHipsterAppli";
