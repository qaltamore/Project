...
import fr.projet.repository.ThemeRepository;
...
public class ThemeResourceIntTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(themeResource, "themeRepository", themeRepository);
    ...
    public void createThemeWithExistingId() throws Exception {
        ...
        restThemeMockMvc.perform(post("/api/themes")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingTheme)))
