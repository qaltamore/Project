...
import fr.hack47.domain.Player;
import fr.hack47.repository.PlayerRepository;
...
import fr.hack47.domain.enumeration.Role;
/**
...
public class PlayerResourceIntTest {
    ...
    private static final Role DEFAULT_ROLE = Role.ATK;
    private static final Role UPDATED_ROLE = Role.DEF;
    ...
    public void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getRole()).isEqualTo(DEFAULT_ROLE);
    }
    ...
    public void updatePlayer() throws Exception {
        ...
        assertThat(testPlayer.getRole()).isEqualTo(UPDATED_ROLE);
    }
